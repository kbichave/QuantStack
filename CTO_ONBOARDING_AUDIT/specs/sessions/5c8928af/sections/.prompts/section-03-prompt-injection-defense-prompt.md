...
Generate content for section `section-03-prompt-injection-defense` (filename: `section-03-prompt-injection-defense.md`).
...
for `section-03-prompt-injection-defense` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-03-prompt-injection-defense.md`
