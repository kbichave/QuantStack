...
Generate content for section `section-04-factor-exposure` (filename: `section-04-factor-exposure.md`).
...
for `section-04-factor-exposure` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/29e1271d/sections/section-04-factor-exposure.md`
