...
Generate content for section `section-08-litellm-proxy` (filename: `section-08-litellm-proxy.md`).
...
for `section-08-litellm-proxy` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/00f08204/sections/section-08-litellm-proxy.md`
