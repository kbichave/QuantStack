...
Generate content for section `section-04-output-schema-validation` (filename: `section-04-output-schema-validation.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/claude-plan.md` - Full implementation plan
2. `/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-output-schema-validation` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-04-output-schema-validation.md`
