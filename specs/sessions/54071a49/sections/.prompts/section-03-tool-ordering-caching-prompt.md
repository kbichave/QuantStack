...
Generate content for section `section-03-tool-ordering-caching` (filename: `section-03-tool-ordering-caching.md`).
...
for `section-03-tool-ordering-caching` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-03-tool-ordering-caching.md`
