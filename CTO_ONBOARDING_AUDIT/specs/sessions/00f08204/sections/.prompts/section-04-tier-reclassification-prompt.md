...
Generate content for section `section-04-tier-reclassification` (filename: `section-04-tier-reclassification.md`).
...
for `section-04-tier-reclassification` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/00f08204/sections/section-04-tier-reclassification.md`
