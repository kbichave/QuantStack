...
Generate content for section `section-04-drift-pre-cache` (filename: `section-04-drift-pre-cache.md`).
...
for `section-04-drift-pre-cache` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-04-drift-pre-cache.md`
