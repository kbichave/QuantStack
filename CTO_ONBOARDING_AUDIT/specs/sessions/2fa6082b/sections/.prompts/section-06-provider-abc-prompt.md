...
Generate content for section `section-06-provider-abc` (filename: `section-06-provider-abc.md`).
...
for `section-06-provider-abc` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-06-provider-abc.md`
