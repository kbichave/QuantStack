[Skip to main content](https://docs.crewai.com/en/learn/bring-your-own-agent#content-area)
...
## [​](https://docs.crewai.com/en/learn/bring-your-own-agent\#adapter-guide-for-bringing-your-own-agents-langgraph-agents,-openai-agents,-etc%E2%80%A6)  Adapter Guide for Bringing your own agents (Langgraph Agents, OpenAI Agents, etc…)
...
## [​](https://docs.crewai.com/en/learn/bring-your-own-agent\#baseagentadapter)  BaseAgentAdapter
...
## [​](https://docs.crewai.com/en/learn/bring-your-own-agent\#basetooladapter-implementation)  BaseToolAdapter implementation

The `BaseToolAdapter` class is responsible for converting CrewAI’s native `BaseTool` objects into a format that your specific external agent framework can understand and utilize. Different agent frameworks (like LangGraph, OpenAI Assistants, etc.) have their own unique ways of defining and handling tools, and the `BaseToolAdapter` acts as the translator.Here’s how you implement your custom tool adapter:
...
## [​](https://docs.crewai.com/en/learn/bring-your-own-agent\#baseconverter)  BaseConverter

The `BaseConverterAdapter` plays a crucial role when a CrewAI `Task` requires an agent to return its final output in a specific structured format, such as JSON or a Pydantic model. It bridges the gap between CrewAI’s structured output requirements and the capabilities of your external agent.Its primary responsibilities are:
...
2. **Enhancing the System Prompt:** It modifies the agent’s system prompt to include clear instructions on _how_ to generate the output in the required structure.
...
_Note: The exact prompt engineering might need tuning based on the agent/LLM being used._
...
## [​](https://docs.crewai.com/en/learn/bring-your-own-agent\#out-of-the-box-adapters)  Out of the Box Adapters
...
## [​](https://docs.crewai.com/en/learn/bring-your-own-agent\#kicking-off-a-crew-with-adapted-agents:)  Kicking off a crew with adapted agents:
