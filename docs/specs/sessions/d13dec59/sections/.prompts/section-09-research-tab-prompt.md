...
Generate content for section `section-09-research-tab` (filename: `section-09-research-tab.md`).
...
for `section-09-research-tab` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/docs/specs/sessions/d13dec59/sections/section-09-research-tab.md`
