...
Generate content for section `section-07-research-graph` (filename: `section-07-research-graph.md`).
...
for `section-07-research-graph` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/sections/section-07-research-graph.md`
