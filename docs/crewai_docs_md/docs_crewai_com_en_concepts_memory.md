[Skip to main content](https://docs.crewai.com/en/concepts/memory#content-area)
...
## [​](https://docs.crewai.com/en/concepts/memory\#overview)  Overview
...
## [​](https://docs.crewai.com/en/concepts/memory\#memory-system-components)  Memory System Components
...
## [​](https://docs.crewai.com/en/concepts/memory\#1-basic-memory-system-recommended)  1\. Basic Memory System (Recommended)

The simplest and most commonly used approach. Enable memory for your crew with a single parameter:

### [​](https://docs.crewai.com/en/concepts/memory\#quick-start)  Quick Start
...
### [​](https://docs.crewai.com/en/concepts/memory\#how-it-works)  How It Works
...
## [​](https://docs.crewai.com/en/concepts/memory\#storage-location-transparency)  Storage Location Transparency
...
### [​](https://docs.crewai.com/en/concepts/memory\#where-crewai-stores-files)  Where CrewAI Stores Files
...
#### [​](https://docs.crewai.com/en/concepts/memory\#default-storage-locations-by-platform)  Default Storage Locations by Platform
...
### [​](https://docs.crewai.com/en/concepts/memory\#finding-your-storage-location)  Finding Your Storage Location
...
### [​](https://docs.crewai.com/en/concepts/memory\#controlling-storage-locations)  Controlling Storage Locations

#### [​](https://docs.crewai.com/en/concepts/memory\#option-1:-environment-variable-recommended)  Option 1: Environment Variable (Recommended)
...
#### [​](https://docs.crewai.com/en/concepts/memory\#option-2:-custom-storage-paths)  Option 2: Custom Storage Paths
...
#### [​](https://docs.crewai.com/en/concepts/memory\#option-3:-project-specific-storage)  Option 3: Project-Specific Storage
...
### [​](https://docs.crewai.com/en/concepts/memory\#embedding-provider-defaults)  Embedding Provider Defaults
...
#### [​](https://docs.crewai.com/en/concepts/memory\#understanding-default-behavior)  Understanding Default Behavior
...
#### [​](https://docs.crewai.com/en/concepts/memory\#customizing-embedding-providers)  Customizing Embedding Providers
...
### [​](https://docs.crewai.com/en/concepts/memory\#debugging-storage-issues)  Debugging Storage Issues

#### [​](https://docs.crewai.com/en/concepts/memory\#check-storage-permissions)  Check Storage Permissions
...
#### [​](https://docs.crewai.com/en/concepts/memory\#inspect-chromadb-collections)  Inspect ChromaDB Collections
...
#### [​](https://docs.crewai.com/en/concepts/memory\#reset-storage-debugging)  Reset Storage (Debugging)
...
### [​](https://docs.crewai.com/en/concepts/memory\#production-best-practices)  Production Best Practices
...
### [​](https://docs.crewai.com/en/concepts/memory\#common-storage-issues)  Common Storage Issues
...
## [​](https://docs.crewai.com/en/concepts/memory\#custom-embedder-configuration)  Custom Embedder Configuration
...
### [​](https://docs.crewai.com/en/concepts/memory\#why-choose-different-embedding-providers)  Why Choose Different Embedding Providers?
...
### [​](https://docs.crewai.com/en/concepts/memory\#openai-embeddings-default)  OpenAI Embeddings (Default)
...
### [​](https://docs.crewai.com/en/concepts/memory\#azure-openai-embeddings)  Azure OpenAI Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#google-ai-embeddings)  Google AI Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#vertex-ai-embeddings)  Vertex AI Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#ollama-embeddings-local)  Ollama Embeddings (Local)
...
### [​](https://docs.crewai.com/en/concepts/memory\#cohere-embeddings)  Cohere Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#voyageai-embeddings)  VoyageAI Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#aws-bedrock-embeddings)  AWS Bedrock Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#hugging-face-embeddings)  Hugging Face Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#ibm-watson-embeddings)  IBM Watson Embeddings
...
### [​](https://docs.crewai.com/en/concepts/memory\#mem0-provider)  Mem0 Provider
...
### [​](https://docs.crewai.com/en/concepts/memory\#choosing-the-right-embedding-provider)  Choosing the Right Embedding Provider
...
### [​](https://docs.crewai.com/en/concepts/memory\#environment-variable-configuration)  Environment Variable Configuration
...
### [​](https://docs.crewai.com/en/concepts/memory\#testing-different-embedding-providers)  Testing Different Embedding Providers
...
### [​](https://docs.crewai.com/en/concepts/memory\#troubleshooting-embedding-issues)  Troubleshooting Embedding Issues
...
### [​](https://docs.crewai.com/en/concepts/memory\#entity-memory-batching-behavior)  Entity Memory batching behavior
...
## [​](https://docs.crewai.com/en/concepts/memory\#2-external-memory)  2\. External Memory

External Memory provides a standalone memory system that operates independently from the crew’s built-in memory. This is ideal for specialized memory providers or cross-application memory sharing.

### [​](https://docs.crewai.com/en/concepts/memory\#basic-external-memory-with-mem0)  Basic External Memory with Mem0
...
### [​](https://docs.crewai.com/en/concepts/memory\#advanced-external-memory-with-mem0-client)  Advanced External Memory with Mem0 Client
...
### [​](https://docs.crewai.com/en/concepts/memory\#custom-storage-implementation)  Custom Storage Implementation
...
## [​](https://docs.crewai.com/en/concepts/memory\#%F0%9F%A7%A0-memory-system-comparison)  🧠 Memory System Comparison
...
## [​](https://docs.crewai.com/en/concepts/memory\#supported-embedding-providers)  Supported Embedding Providers

### [​](https://docs.crewai.com/en/concepts/memory\#openai-default)  OpenAI (Default)
...
### [​](https://docs.crewai.com/en/concepts/memory\#ollama)  Ollama
...
### [​](https://docs.crewai.com/en/concepts/memory\#google-ai)  Google AI
...
### [​](https://docs.crewai.com/en/concepts/memory\#azure-openai)  Azure OpenAI
...
### [​](https://docs.crewai.com/en/concepts/memory\#vertex-ai)  Vertex AI
...
## [​](https://docs.crewai.com/en/concepts/memory\#security-best-practices)  Security Best Practices

### [​](https://docs.crewai.com/en/concepts/memory\#environment-variables)  Environment Variables
...
### [​](https://docs.crewai.com/en/concepts/memory\#storage-security)  Storage Security
...
## [​](https://docs.crewai.com/en/concepts/memory\#troubleshooting)  Troubleshooting

### [​](https://docs.crewai.com/en/concepts/memory\#common-issues)  Common Issues
...
### [​](https://docs.crewai.com/en/concepts/memory\#performance-tips)  Performance Tips
...
## [​](https://docs.crewai.com/en/concepts/memory\#benefits-of-using-crewai%E2%80%99s-memory-system)  Benefits of Using CrewAI’s Memory System

- 🦾 **Adaptive Learning:** Crews become more efficient over time, adapting to new information and refining their approach to tasks.
- 🫡 **Enhanced Personalization:** Memory enables agents to remember user preferences and historical interactions, leading to personalized experiences.
- 🧠 **Improved Problem Solving:** Access to a rich memory store aids agents in making more informed decisions, drawing on past learnings and contextual insights.

## [​](https://docs.crewai.com/en/concepts/memory\#memory-events)  Memory Events
...
### [​](https://docs.crewai.com/en/concepts/memory\#available-memory-events)  Available Memory Events
...
### [​](https://docs.crewai.com/en/concepts/memory\#practical-applications)  Practical Applications

#### [​](https://docs.crewai.com/en/concepts/memory\#1-memory-performance-monitoring)  1\. Memory Performance Monitoring
...
#### [​](https://docs.crewai.com/en/concepts/memory\#2-memory-content-logging)  2\. Memory Content Logging
...
#### [​](https://docs.crewai.com/en/concepts/memory\#3-error-tracking-and-notifications)  3\. Error Tracking and Notifications
...
### [​](https://docs.crewai.com/en/concepts/memory\#integrating-with-analytics-platforms)  Integrating with Analytics Platforms
...
### [​](https://docs.crewai.com/en/concepts/memory\#best-practices-for-memory-event-listeners)  Best Practices for Memory Event Listeners
...
## [​](https://docs.crewai.com/en/concepts/memory\#conclusion)  Conclusion
...
[Training\\
\\
Previous](https://docs.crewai.com/en/concepts/training) [Reasoning\\
\\
Next](https://docs.crewai.com/en/concepts/reasoning)
