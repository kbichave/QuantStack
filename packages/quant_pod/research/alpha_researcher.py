        ...
        for h in plan.hypotheses:
            try:
                self._conn.execute(
                    ...
                    """,
                    [
                        h.hypothesis_id, h.thesis, h.priority, h.source,
                        json.dumps(h.target_regimes), json.dumps(h.target_symbols),
                        plan.plan_id,
                    ],
                )
            except Exception as exc:
