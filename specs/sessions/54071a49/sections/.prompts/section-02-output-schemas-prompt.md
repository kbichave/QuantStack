...
Generate content for section `section-02-output-schemas` (filename: `section-02-output-schemas.md`).
...
for `section-02-output-schemas` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-02-output-schemas.md`
