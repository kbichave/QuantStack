...
Generate content for section `section-08-database-backups` (filename: `section-08-database-backups.md`).
...
for `section-08-database-backups` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-08-database-backups.md`
