...
Generate content for section `section-06-supervisor-graph` (filename: `section-06-supervisor-graph.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/claude-plan.md` - Full implementation plan
2. `/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-supervisor-graph` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/sections/section-06-supervisor-graph.md`
