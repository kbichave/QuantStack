...
Generate content for section `section-04-state-schemas` (filename: `section-04-state-schemas.md`).
...
for `section-04-state-schemas` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/sections/section-04-state-schemas.md`
