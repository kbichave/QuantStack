...
Generate content for section `section-03-tool-wrappers` (filename: `section-03-tool-wrappers.md`).
...
for `section-03-tool-wrappers` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/sections/section-03-tool-wrappers.md`
