...
Generate content for section `section-08-multi-mode` (filename: `section-08-multi-mode.md`).
...
for `section-08-multi-mode` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/29e1271d/sections/section-08-multi-mode.md`
