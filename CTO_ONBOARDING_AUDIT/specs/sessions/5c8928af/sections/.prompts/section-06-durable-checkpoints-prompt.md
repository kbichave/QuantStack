...
Generate content for section `section-06-durable-checkpoints` (filename: `section-06-durable-checkpoints.md`).
...
for `section-06-durable-checkpoints` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-06-durable-checkpoints.md`
