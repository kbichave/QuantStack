...
class PaperBroker:
    ...
    def __init__(
        ...
        self._portfolio = portfolio if portfolio is not None else get_portfolio_state(self._conn)
    ...
    def execute(self, req: OrderRequest) -> Fill:
        ...
        daily_vol = req.daily_volume if req.daily_volume > 0 else self.DEFAULT_DAILY_VOLUME
