    ...
    def _init_schema(self) -> None:
        ...
        self.conn.execute(
            ...
            CREATE TABLE IF NOT EXISTS trade_journal (
                ...
                max_profit_potential DOUBLE PRECISION,
                max_loss_potential DOUBLE PRECISION,
        ...
        self.conn.execute(
            ...
            CREATE TABLE IF NOT EXISTS wave_scenarios (
                ...
                primary_target DOUBLE PRECISION,
                secondary_target DOUBLE PRECISION,
        ...
        self.conn.execute(
            ...
            CREATE TABLE IF NOT EXISTS regime_states (
                ...
                correlation_to_spy DOUBLE PRECISION,
        ...
        self.conn.execute(
            ...
            CREATE TABLE IF NOT EXISTS performance_metrics (
                ...
                avg_pnl_per_trade DOUBLE PRECISION DEFAULT 0.0,
                largest_win DOUBLE PRECISION DEFAULT 0.0,
                largest_loss DOUBLE PRECISION DEFAULT 0.0,
