...
Generate content for section `section-13-funding-costs` (filename: `section-13-funding-costs.md`).
...
for `section-13-funding-costs` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-13-funding-costs.md`
