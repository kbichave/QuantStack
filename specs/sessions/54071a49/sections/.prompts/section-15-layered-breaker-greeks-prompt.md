...
Generate content for section `section-15-layered-breaker-greeks` (filename: `section-15-layered-breaker-greeks.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/claude-plan.md` - Full implementation plan
2. `/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-15-layered-breaker-greeks` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-15-layered-breaker-greeks.md`
