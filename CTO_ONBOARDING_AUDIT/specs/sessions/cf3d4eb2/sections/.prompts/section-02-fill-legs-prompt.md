...
Generate content for section `section-02-fill-legs` (filename: `section-02-fill-legs.md`).
...
for `section-02-fill-legs` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-02-fill-legs.md`
