...
# Target universe: 50 tickers (15 ETFs + 35 stocks)
#
# Selection criteria:
#   - ETFs: broadest market coverage + highest-volume vol/sector instruments
#   - Stocks: top ADV and options-volume name per sector; all pass 500k+ shares/day
#
# All 50 symbols are supported by Alpha Vantage TIME_SERIES_INTRADAY (adjusted)
