...
Generate content for section `section-10-transaction-isolation` (filename: `section-10-transaction-isolation.md`).
...
for `section-10-transaction-isolation` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-10-transaction-isolation.md`
