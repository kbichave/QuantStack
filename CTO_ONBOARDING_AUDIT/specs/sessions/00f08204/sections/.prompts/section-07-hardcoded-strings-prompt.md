...
Generate content for section `section-07-hardcoded-strings` (filename: `section-07-hardcoded-strings.md`).
...
for `section-07-hardcoded-strings` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/00f08204/sections/section-07-hardcoded-strings.md`
