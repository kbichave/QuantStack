...
Generate content for section `section-05-temperature-config` (filename: `section-05-temperature-config.md`).
...
for `section-05-temperature-config` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/00f08204/sections/section-05-temperature-config.md`
