...
Generate content for section `section-12-multi-mode` (filename: `section-12-multi-mode.md`).
...
for `section-12-multi-mode` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-12-multi-mode.md`
