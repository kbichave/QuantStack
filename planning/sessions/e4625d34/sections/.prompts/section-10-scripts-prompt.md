...
Generate content for section `section-10-scripts` (filename: `section-10-scripts.md`).
...
for `section-10-scripts` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/sections/section-10-scripts.md`
