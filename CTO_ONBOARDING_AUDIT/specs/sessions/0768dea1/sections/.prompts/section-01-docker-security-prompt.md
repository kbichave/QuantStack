...
Generate content for section `section-01-docker-security` (filename: `section-01-docker-security.md`).
...
for `section-01-docker-security` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/0768dea1/sections/section-01-docker-security.md`
