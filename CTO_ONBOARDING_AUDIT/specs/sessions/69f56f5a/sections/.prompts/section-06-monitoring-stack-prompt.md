...
Generate content for section `section-06-monitoring-stack` (filename: `section-06-monitoring-stack.md`).
...
for `section-06-monitoring-stack` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/69f56f5a/sections/section-06-monitoring-stack.md`
