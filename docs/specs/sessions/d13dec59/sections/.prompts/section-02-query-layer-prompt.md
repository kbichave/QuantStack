...
Generate content for section `section-02-query-layer` (filename: `section-02-query-layer.md`).
...
for `section-02-query-layer` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/docs/specs/sessions/d13dec59/sections/section-02-query-layer.md`
