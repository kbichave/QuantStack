...
Generate content for section `section-07-ic-weight-adjustment` (filename: `section-07-ic-weight-adjustment.md`).
...
for `section-07-ic-weight-adjustment` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/section-07-ic-weight-adjustment.md`
