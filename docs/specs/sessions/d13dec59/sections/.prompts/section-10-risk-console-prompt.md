...
Generate content for section `section-10-risk-console` (filename: `section-10-risk-console.md`).
...
for `section-10-risk-console` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/docs/specs/sessions/d13dec59/sections/section-10-risk-console.md`
