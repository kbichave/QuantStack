[Skip to main content](https://docs.crewai.com/en/tools/tool-integrations/overview#content-area)
...
## [​](https://docs.crewai.com/en/tools/tool-integrations/overview\#available-integrations)  Available Integrations

[**Bedrock Invoke Agent Tool** \\
\\
Invoke Amazon Bedrock Agents from CrewAI to orchestrate actions across AWS services.](https://docs.crewai.com/en/tools/integration/bedrockinvokeagenttool) [**CrewAI Automation Tool** \\
\\
Automate deployment and operations by integrating CrewAI with external platforms and workflows.](https://docs.crewai.com/en/tools/integration/crewaiautomationtool)
