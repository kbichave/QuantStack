[Skip to main content](https://docs.crewai.com/en/concepts/llms#content-area)
...
## [​](https://docs.crewai.com/en/concepts/llms\#overview)  Overview
...
## [​](https://docs.crewai.com/en/concepts/llms\#what-are-llms)  What are LLMs?
...
## [​](https://docs.crewai.com/en/concepts/llms\#setting-up-your-llm)  Setting up your LLM

There are different places in CrewAI code where you can specify the model to use. Once you specify the model you are using, you will need to provide the configuration (like an API key) for each of the model providers you use. See the [provider configuration examples](https://docs.crewai.com/en/concepts/llms#provider-configuration-examples) section for your provider.
...
## [​](https://docs.crewai.com/en/concepts/llms\#provider-configuration-examples)  Provider Configuration Examples
...
## [​](https://docs.crewai.com/en/concepts/llms\#streaming-responses)  Streaming Responses
...
## [​](https://docs.crewai.com/en/concepts/llms\#async-llm-calls)  Async LLM Calls
...
## [​](https://docs.crewai.com/en/concepts/llms\#structured-llm-calls)  Structured LLM Calls
...
## [​](https://docs.crewai.com/en/concepts/llms\#advanced-features-and-optimization)  Advanced Features and Optimization
...
## [​](https://docs.crewai.com/en/concepts/llms\#common-issues-and-solutions)  Common Issues and Solutions
...
[Knowledge\\
\\
Previous](https://docs.crewai.com/en/concepts/knowledge) [Processes\\
\\
Next](https://docs.crewai.com/en/concepts/processes)
