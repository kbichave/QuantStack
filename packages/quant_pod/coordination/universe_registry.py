...
LIQUID_ETFS: list[dict[str, str]] = [
    ...
    {"symbol": "XLY", "name": "Consumer Discretionary SPDR", "sector": "Consumer Discretionary"},
    ...
    {"symbol": "XHB", "name": "SPDR S&P Homebuilders ETF", "sector": "Consumer Discretionary"},
    {"symbol": "XRT", "name": "SPDR S&P Retail ETF", "sector": "Consumer Discretionary"},
    ...
    {"symbol": "UNG", "name": "United States Natural Gas Fund", "sector": "Commodities"},
    {"symbol": "GDX", "name": "VanEck Gold Miners ETF", "sector": "Commodities"},
    {"symbol": "GDXJ", "name": "VanEck Junior Gold Miners ETF", "sector": "Commodities"},
    # Bonds
    ...
    {"symbol": "LQD", "name": "iShares iBoxx $ Invest Grade Corp Bond ETF", "sector": "Bonds"},
    ...
    {"symbol": "UVXY", "name": "ProShares Ultra VIX Short-Term Futures ETF", "sector": "Volatility"},
    # International
...
class UniverseRegistry:
    ...
    def get_refresh_age_hours(self) -> float:
        ...
        row = self._conn.execute(
            "SELECT MAX(last_refreshed) FROM universe"
        ).fetchone()
    ...
    def _upsert(
        ...
        if existing:
            ...
            self._conn.execute(
                ...
                VALUES (?, ?, ?, ?, ?, ?, TRUE, ?, ?)
                """,
                [symbol, name, sector, source.value, market_cap, avg_daily_volume, now, now],
            )
            return (1, 0)
    ...
    def _parse_screener_response(self, resp: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        for item in results:
            ...
            records.append({
                ...
                "market_cap": item.get("market_cap", item.get("market_capitalization")),
