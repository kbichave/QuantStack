...
Generate content for section `section-04-rate-limiter` (filename: `section-04-rate-limiter.md`).
...
for `section-04-rate-limiter` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/69f56f5a/sections/section-04-rate-limiter.md`
