...
def validate_ic_output(ic_name: str, output: str) -> ICValidationResult:
    ...
    if not required:
        ...
        return ICValidationResult(ic_name=ic_name, is_valid=True, output_length=len(output))
...
def validate_all_ic_outputs(ic_outputs: dict[str, str]) -> dict[str, ICValidationResult]:
