...
Generate content for section `section-11-message-pruning` (filename: `section-11-message-pruning.md`).
...
for `section-11-message-pruning` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e0037533/sections/section-11-message-pruning.md`
