...
class DegradationDetector:
    ...
    def check(
        ...
        report = DegradationReport(
            ...
            rolling_window_days=rolling_days,
            is_benchmark=benchmark,
            sharpe_ratio_oos_vs_is=round(oos_is_ratio, 3) if oos_is_ratio is not None else None,
            drawdown_ratio_vs_predicted=round(dd_ratio, 2) if dd_ratio is not None else None,
            findings=findings,
    ...
    def _classify(
        ...
        elif live_sharpe < 0.5 and benchmark and benchmark.predicted_annual_sharpe >= 1.0:
            findings.append(
