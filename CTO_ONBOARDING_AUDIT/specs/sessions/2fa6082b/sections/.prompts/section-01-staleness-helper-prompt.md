...
Generate content for section `section-01-staleness-helper` (filename: `section-01-staleness-helper.md`).
...
for `section-01-staleness-helper` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-01-staleness-helper.md`
