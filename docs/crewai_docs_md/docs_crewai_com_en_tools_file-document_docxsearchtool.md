[Skip to main content](https://docs.crewai.com/en/tools/file-document/docxsearchtool#content-area)
...
# [​](https://docs.crewai.com/en/tools/file-document/docxsearchtool\#docxsearchtool)  `DOCXSearchTool`

We are still working on improving tools, so there might be unexpected behavior or changes in the future.

## [​](https://docs.crewai.com/en/tools/file-document/docxsearchtool\#description)  Description
...
## [​](https://docs.crewai.com/en/tools/file-document/docxsearchtool\#installation)  Installation
...
## [​](https://docs.crewai.com/en/tools/file-document/docxsearchtool\#example)  Example
...
## [​](https://docs.crewai.com/en/tools/file-document/docxsearchtool\#arguments)  Arguments
...
## [​](https://docs.crewai.com/en/tools/file-document/docxsearchtool\#custom-model-and-embeddings)  Custom model and embeddings
...
[PDF RAG Search\\
\\
Previous](https://docs.crewai.com/en/tools/file-document/pdfsearchtool) [MDX RAG Search\\
\\
Next](https://docs.crewai.com/en/tools/file-document/mdxsearchtool)
