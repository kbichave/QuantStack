...
Generate content for section `section-04-failure-taxonomy` (filename: `section-04-failure-taxonomy.md`).
...
for `section-04-failure-taxonomy` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/section-04-failure-taxonomy.md`
