...
Generate content for section `section-10-knowledge-graph` (filename: `section-10-knowledge-graph.md`).
...
for `section-10-knowledge-graph` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e1caa082/sections/section-10-knowledge-graph.md`
