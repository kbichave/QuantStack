...
Generate content for section `section-03-business-calendar` (filename: `section-03-business-calendar.md`).
...
for `section-03-business-calendar` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-03-business-calendar.md`
