...
class Settings(BaseSettings):
    ...
    # Data Settings
    data_start_date: str = Field(default="2019-01-01", description="Start date for historical data")
    ...
    # Training Settings
    train_start_date: str = Field(default="2019-01-01", description="Training period start")
    train_end_date: str = Field(default="2022-12-31", description="Training period end")
    validation_start_date: str = Field(default="2023-01-01", description="Validation period start")
    validation_end_date: str = Field(default="2023-06-30", description="Validation period end")
    ...
    max_concurrent_trades: int = Field(default=5, description="Maximum concurrent open positions")
