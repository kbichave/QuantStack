...
This module is pure logic — no DB access.  The MCP tools in server.py
call this with pre-fetched data.
"""
...
def compute_allocation(
    ...
    for strat in eligible:
        ...
        max_pos = risk_params.get("max_position_pct", risk_params.get("position_pct", 0.10))
