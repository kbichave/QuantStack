...
Generate content for section `section-07-circuit-breaker` (filename: `section-07-circuit-breaker.md`).
...
for `section-07-circuit-breaker` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e0037533/sections/section-07-circuit-breaker.md`
