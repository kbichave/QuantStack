...
Generate content for section `section-05-rag-fix` (filename: `section-05-rag-fix.md`).
...
for `section-05-rag-fix` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/0768dea1/sections/section-05-rag-fix.md`
