...
Generate content for section `section-04-node-output-models` (filename: `section-04-node-output-models.md`).
...
for `section-04-node-output-models` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e0037533/sections/section-04-node-output-models.md`
