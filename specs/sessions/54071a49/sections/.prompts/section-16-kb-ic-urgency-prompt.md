...
Generate content for section `section-16-kb-ic-urgency` (filename: `section-16-kb-ic-urgency.md`).
...
for `section-16-kb-ic-urgency` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-16-kb-ic-urgency.md`
