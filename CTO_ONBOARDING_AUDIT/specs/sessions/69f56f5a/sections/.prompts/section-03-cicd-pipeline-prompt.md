...
Generate content for section `section-03-cicd-pipeline` (filename: `section-03-cicd-pipeline.md`).
...
for `section-03-cicd-pipeline` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/69f56f5a/sections/section-03-cicd-pipeline.md`
