...
class PortfolioOrchestrator:
    ...
    def gate_entries(
        ...
        for trade in proposed_trades:
            if trade.symbol in current_positions:
                ...
                report.results.append(
                    GatedTrade(trade=trade, approved=False, rejection_reason="Already holding position")
                )
            else:
        ...
        for trade in remaining:
            ...
            sector_pct = (sector_count + 1) / total_positions if total_positions > 0 else 0
            ...
            report.approved += 1
            report.results.append(
                GatedTrade(trade=trade, approved=True, adjusted_size=trade.position_size)
            )
