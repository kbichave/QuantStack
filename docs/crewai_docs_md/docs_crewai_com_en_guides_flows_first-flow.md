[Skip to main content](https://docs.crewai.com/en/guides/flows/first-flow#content-area)
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#taking-control-of-ai-workflows-with-flows)  Taking Control of AI Workflows with Flows
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#what-makes-flows-powerful)  What Makes Flows Powerful
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#what-you%E2%80%99ll-build-and-learn)  What You’ll Build and Learn
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#prerequisites)  Prerequisites
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-1:-create-a-new-crewai-flow-project)  Step 1: Create a New CrewAI Flow Project
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-2:-understanding-the-project-structure)  Step 2: Understanding the Project Structure
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-3:-add-a-content-writer-crew)  Step 3: Add a Content Writer Crew
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-4:-configure-the-content-writer-crew)  Step 4: Configure the Content Writer Crew
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-5:-create-the-flow)  Step 5: Create the Flow
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-6:-set-up-your-environment-variables)  Step 6: Set Up Your Environment Variables
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-7:-install-dependencies)  Step 7: Install Dependencies
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-8:-run-your-flow)  Step 8: Run Your Flow
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-9:-visualize-your-flow)  Step 9: Visualize Your Flow
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#step-10:-review-the-output)  Step 10: Review the Output
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#the-art-of-the-possible:-beyond-your-first-flow)  The Art of the Possible: Beyond Your First Flow
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#enhancing-user-interaction)  Enhancing User Interaction
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#adding-more-processing-steps)  Adding More Processing Steps
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#creating-more-complex-flows)  Creating More Complex Flows
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#applying-to-different-domains)  Applying to Different Domains
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#key-features-demonstrated)  Key Features Demonstrated
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#understanding-the-flow-structure)  Understanding the Flow Structure

Let’s break down the key components of flows to help you understand how to build your own:

### [​](https://docs.crewai.com/en/guides/flows/first-flow\#1-direct-llm-calls)  1\. Direct LLM Calls
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#2-event-driven-architecture)  2\. Event-Driven Architecture
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#3-state-management)  3\. State Management
...
### [​](https://docs.crewai.com/en/guides/flows/first-flow\#4-crew-integration)  4\. Crew Integration
...
## [​](https://docs.crewai.com/en/guides/flows/first-flow\#next-steps)  Next Steps
...
\\
Previous](https://docs.crewai.com/en/guides/crews/first-crew) [Mastering Flow State Management\\
\\
Next](https://docs.crewai.com/en/guides/flows/mastering-flow-state)
...
![CrewAI Framework Overview](https://mintcdn.com/crewai/qVjgZHKAyEOgSSUS/images/flows.png?w=1100&fit=max&auto=format&n=qVjgZHKAyEOgSSUS&q=85&s=540eb3d8d8f256d6d703aa5e6111a4cd)