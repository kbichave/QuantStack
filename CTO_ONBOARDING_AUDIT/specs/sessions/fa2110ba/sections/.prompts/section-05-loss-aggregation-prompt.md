...
Generate content for section `section-05-loss-aggregation` (filename: `section-05-loss-aggregation.md`).
...
for `section-05-loss-aggregation` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/section-05-loss-aggregation.md`
