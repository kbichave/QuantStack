...
Generate content for section `section-03-error-driven-research` (filename: `section-03-error-driven-research.md`).
...
for `section-03-error-driven-research` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e1caa082/sections/section-03-error-driven-research.md`
