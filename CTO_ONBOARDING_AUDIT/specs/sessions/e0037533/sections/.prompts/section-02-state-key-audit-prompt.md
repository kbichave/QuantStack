...
Generate content for section `section-02-state-key-audit` (filename: `section-02-state-key-audit.md`).
...
for `section-02-state-key-audit` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e0037533/sections/section-02-state-key-audit.md`
