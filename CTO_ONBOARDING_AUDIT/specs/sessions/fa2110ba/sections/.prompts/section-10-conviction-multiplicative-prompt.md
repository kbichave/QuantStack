...
Generate content for section `section-10-conviction-multiplicative` (filename: `section-10-conviction-multiplicative.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/claude-plan.md` - Full implementation plan
2. `/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-10-conviction-multiplicative` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/section-10-conviction-multiplicative.md`
