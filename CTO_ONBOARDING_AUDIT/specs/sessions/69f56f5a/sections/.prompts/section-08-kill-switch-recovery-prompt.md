...
Generate content for section `section-08-kill-switch-recovery` (filename: `section-08-kill-switch-recovery.md`).
...
for `section-08-kill-switch-recovery` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/69f56f5a/sections/section-08-kill-switch-recovery.md`
