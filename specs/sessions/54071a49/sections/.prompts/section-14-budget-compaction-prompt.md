...
Generate content for section `section-14-budget-compaction` (filename: `section-14-budget-compaction.md`).
...
for `section-14-budget-compaction` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-14-budget-compaction.md`
