...
## [​](https://docs.crewai.com/en/concepts/tasks\#overview)  Overview
...
### [​](https://docs.crewai.com/en/concepts/tasks\#task-execution-flow)  Task Execution Flow
...
## [​](https://docs.crewai.com/en/concepts/tasks\#task-attributes)  Task Attributes
...
| **Create Directory** _(optional)_ | `create_directory` | `Optional[bool]` | Whether to create the directory for output\_file if it doesn’t exist. Defaults to True. |  |
...
## [​](https://docs.crewai.com/en/concepts/tasks\#creating-tasks)  Creating Tasks

There are two ways to create tasks in CrewAI: using **YAML configuration (recommended)** or defining them **directly in code**.

### [​](https://docs.crewai.com/en/concepts/tasks\#yaml-configuration-recommended)  YAML Configuration (Recommended)
...
### [​](https://docs.crewai.com/en/concepts/tasks\#direct-code-definition-alternative)  Direct Code Definition (Alternative)
...
## [​](https://docs.crewai.com/en/concepts/tasks\#task-output)  Task Output
...
### [​](https://docs.crewai.com/en/concepts/tasks\#task-output-attributes)  Task Output Attributes
...
### [​](https://docs.crewai.com/en/concepts/tasks\#task-methods-and-properties)  Task Methods and Properties
...
### [​](https://docs.crewai.com/en/concepts/tasks\#accessing-task-outputs)  Accessing Task Outputs

Once a task has been executed, its output can be accessed through the `output` attribute of the `Task` object. The `TaskOutput` class provides various ways to interact with and present this output.

#### [​](https://docs.crewai.com/en/concepts/tasks\#example)  Example
...
## [​](https://docs.crewai.com/en/concepts/tasks\#markdown-output-formatting)  Markdown Output Formatting
...
### [​](https://docs.crewai.com/en/concepts/tasks\#using-markdown-formatting)  Using Markdown Formatting
...
### [​](https://docs.crewai.com/en/concepts/tasks\#yaml-configuration-with-markdown)  YAML Configuration with Markdown
...
### [​](https://docs.crewai.com/en/concepts/tasks\#benefits-of-markdown-output)  Benefits of Markdown Output
...
## [​](https://docs.crewai.com/en/concepts/tasks\#task-dependencies-and-context)  Task Dependencies and Context
...
## [​](https://docs.crewai.com/en/concepts/tasks\#task-guardrails)  Task Guardrails

Task guardrails provide a way to validate and transform task outputs before they
are passed to the next task. This feature helps ensure data quality and provides
feedback to agents when their output doesn’t meet specific criteria.CrewAI supports two types of guardrails:
...
### [​](https://docs.crewai.com/en/concepts/tasks\#function-based-guardrails)  Function-Based Guardrails
...
### [​](https://docs.crewai.com/en/concepts/tasks\#llm-based-guardrails-string-descriptions)  LLM-Based Guardrails (String Descriptions)
...
### [​](https://docs.crewai.com/en/concepts/tasks\#multiple-guardrails)  Multiple Guardrails
...
### [​](https://docs.crewai.com/en/concepts/tasks\#guardrail-function-requirements)  Guardrail Function Requirements

1. **Function Signature**:   - Must accept exactly one parameter (the task output)
   - Should return a tuple of `(bool, Any)`
   - Type hints are recommended but optional
2. **Return Values**:   - On success: it returns a tuple of `(bool, Any)`. For example: `(True, validated_result)`
   - On Failure: it returns a tuple of `(bool, str)`. For example: `(False, "Error message explain the failure")`

### [​](https://docs.crewai.com/en/concepts/tasks\#error-handling-best-practices)  Error Handling Best Practices
...
2. **Error Categories**:   - Use specific error codes
...
### [​](https://docs.crewai.com/en/concepts/tasks\#handling-guardrail-results)  Handling Guardrail Results
...
## [​](https://docs.crewai.com/en/concepts/tasks\#getting-structured-consistent-outputs-from-tasks)  Getting Structured Consistent Outputs from Tasks

It’s also important to note that the output of the final task of a crew becomes the final output of the actual crew itself.

### [​](https://docs.crewai.com/en/concepts/tasks\#using-output-pydantic)  Using `output_pydantic`

The `output_pydantic` property allows you to define a Pydantic model that the task output should conform to. This ensures that the output is not only structured but also validated according to the Pydantic model.Here’s an example demonstrating how to use output\_pydantic:
...
#### [​](https://docs.crewai.com/en/concepts/tasks\#explanation-of-accessing-the-output)  Explanation of Accessing the Output
...
### [​](https://docs.crewai.com/en/concepts/tasks\#using-output-json)  Using `output_json`
...
#### [​](https://docs.crewai.com/en/concepts/tasks\#explanation-of-accessing-the-output-2)  Explanation of Accessing the Output
...
## [​](https://docs.crewai.com/en/concepts/tasks\#integrating-tools-with-tasks)  Integrating Tools with Tasks

Leverage tools from the [CrewAI Toolkit](https://github.com/joaomdmoura/crewai-tools) and [LangChain Tools](https://python.langchain.com/docs/integrations/tools) for enhanced task performance and agent interaction.

## [​](https://docs.crewai.com/en/concepts/tasks\#creating-a-task-with-tools)  Creating a Task with Tools
...
## [​](https://docs.crewai.com/en/concepts/tasks\#referring-to-other-tasks)  Referring to Other Tasks
...
## [​](https://docs.crewai.com/en/concepts/tasks\#asynchronous-execution)  Asynchronous Execution
...
## [​](https://docs.crewai.com/en/concepts/tasks\#callback-mechanism)  Callback Mechanism
...
## [​](https://docs.crewai.com/en/concepts/tasks\#accessing-a-specific-task-output)  Accessing a Specific Task Output
...
## [​](https://docs.crewai.com/en/concepts/tasks\#tool-override-mechanism)  Tool Override Mechanism

Specifying tools in a task allows for dynamic adaptation of agent capabilities, emphasizing CrewAI’s flexibility.

## [​](https://docs.crewai.com/en/concepts/tasks\#error-handling-and-validation-mechanisms)  Error Handling and Validation Mechanisms
...
## [​](https://docs.crewai.com/en/concepts/tasks\#creating-directories-when-saving-files)  Creating Directories when Saving Files
...
### [​](https://docs.crewai.com/en/concepts/tasks\#default-behavior)  Default Behavior
...
### [​](https://docs.crewai.com/en/concepts/tasks\#disabling-directory-creation)  Disabling Directory Creation
...
### [​](https://docs.crewai.com/en/concepts/tasks\#yaml-configuration)  YAML Configuration
...
### [​](https://docs.crewai.com/en/concepts/tasks\#use-cases)  Use Cases
...
### [​](https://docs.crewai.com/en/concepts/tasks\#error-handling)  Error Handling
...
How to Get Consistent Structured Outputs from AI Agent Tasks in CrewAI - YouTube
...
[How to Get Consistent Structured Outputs from AI Agent Tasks in CrewAI](https://www.youtube.com/watch?v=dNpKQk5uxHw)
...
[Watch on](https://www.youtube.com/watch?v=dNpKQk5uxHw&embeds_referring_euri=https%3A%2F%2Fdocs.crewai.com%2F)
...
## [​](https://docs.crewai.com/en/concepts/tasks\#conclusion)  Conclusion
...
[Agents\\
\\
Previous](https://docs.crewai.com/en/concepts/agents) [Crews\\
\\
Next](https://docs.crewai.com/en/concepts/crews)
