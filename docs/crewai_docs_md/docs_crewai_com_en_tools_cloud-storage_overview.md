[Skip to main content](https://docs.crewai.com/en/tools/cloud-storage/overview#content-area)
...
- Cloud & Storage
  ...
  - [Overview](https://docs.crewai.com/en/tools/cloud-storage/overview)
  - [S3 Reader Tool](https://docs.crewai.com/en/tools/cloud-storage/s3readertool)
  - [S3 Writer Tool](https://docs.crewai.com/en/tools/cloud-storage/s3writertool)
  - [Bedrock Knowledge Base Retriever](https://docs.crewai.com/en/tools/cloud-storage/bedrockkbretriever)
- Integrations
...
## [​](https://docs.crewai.com/en/tools/cloud-storage/overview\#available-tools)  **Available Tools**

[**S3 Reader Tool** \\
\\
Read files and data from Amazon S3 buckets.](https://docs.crewai.com/en/tools/cloud-storage/s3readertool) [**S3 Writer Tool** \\
\\
Write and upload files to Amazon S3 storage.](https://docs.crewai.com/en/tools/cloud-storage/s3writertool) [**Bedrock Invoke Agent** \\
\\
Invoke Amazon Bedrock agents for AI-powered tasks.](https://docs.crewai.com/en/tools/integration/bedrockinvokeagenttool) [**Bedrock KB Retriever** \\
\\
Retrieve information from Amazon Bedrock knowledge bases.](https://docs.crewai.com/en/tools/cloud-storage/bedrockkbretriever)

## [​](https://docs.crewai.com/en/tools/cloud-storage/overview\#common-use-cases)  **Common Use Cases**
...
[Code Interpreter\\
\\
Previous](https://docs.crewai.com/en/tools/ai-ml/codeinterpretertool) [S3 Reader Tool\\
\\
Next](https://docs.crewai.com/en/tools/cloud-storage/s3readertool)
