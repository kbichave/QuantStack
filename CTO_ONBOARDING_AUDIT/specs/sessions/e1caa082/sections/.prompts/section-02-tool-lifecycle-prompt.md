...
Generate content for section `section-02-tool-lifecycle` (filename: `section-02-tool-lifecycle.md`).
...
for `section-02-tool-lifecycle` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e1caa082/sections/section-02-tool-lifecycle.md`
