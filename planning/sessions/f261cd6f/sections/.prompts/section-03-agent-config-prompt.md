...
Generate content for section `section-03-agent-config` (filename: `section-03-agent-config.md`).
...
for `section-03-agent-config` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/sections/section-03-agent-config.md`
