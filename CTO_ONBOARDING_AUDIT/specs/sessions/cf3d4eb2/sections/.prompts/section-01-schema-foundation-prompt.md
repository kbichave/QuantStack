...
Generate content for section `section-01-schema-foundation` (filename: `section-01-schema-foundation.md`).
...
for `section-01-schema-foundation` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-01-schema-foundation.md`
