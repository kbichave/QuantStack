...
"""
Shared Pydantic schemas — domain models used across layers.

These schemas define structured outputs for analysis, briefs, and trade
decisions. They live in the shared layer (L0) so any module can import
them without creating upward dependency violations.
"""
