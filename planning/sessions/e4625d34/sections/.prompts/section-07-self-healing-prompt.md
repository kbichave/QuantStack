...
Generate content for section `section-07-self-healing` (filename: `section-07-self-healing.md`).
...
for `section-07-self-healing` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/sections/section-07-self-healing.md`
