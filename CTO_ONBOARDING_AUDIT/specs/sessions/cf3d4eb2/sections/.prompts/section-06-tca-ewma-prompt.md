...
Generate content for section `section-06-tca-ewma` (filename: `section-06-tca-ewma.md`).
...
for `section-06-tca-ewma` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-06-tca-ewma.md`
