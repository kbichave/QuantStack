...
class SignalCache:
        ...
        with self._lock:
            ...
            if self._conn is not None:
                try:
                    ...
                    logger.warning(f"[SignalCache] Failed to delete {symbol} from DB: {e}")
    ...
    def _persist(self, signal: TradeSignal) -> None:
        ...
        try:
            ...
            logger.warning(f"[SignalCache] Failed to persist {signal.symbol} to DB: {e}")
    ...
    def _load_from_db(self) -> None:
        ...
        try:
            ...
            logger.warning(f"[SignalCache] Could not load signals from DB on startup: {e}")
