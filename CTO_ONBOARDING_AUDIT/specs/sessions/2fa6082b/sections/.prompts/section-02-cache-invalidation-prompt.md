...
Generate content for section `section-02-cache-invalidation` (filename: `section-02-cache-invalidation.md`).
...
for `section-02-cache-invalidation` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-02-cache-invalidation.md`
