...
Generate content for section `section-05-non-root-containers` (filename: `section-05-non-root-containers.md`).
...
for `section-05-non-root-containers` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-05-non-root-containers.md`
