...
Generate content for section `section-07-fred-provider` (filename: `section-07-fred-provider.md`).
...
for `section-07-fred-provider` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-07-fred-provider.md`
