...
Generate content for section `section-04-agent-definitions` (filename: `section-04-agent-definitions.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/claude-plan.md` - Full implementation plan
2. `/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/claude-plan-tdd.md` - Test stubs for each section
3. `/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-04-agent-definitions` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/e4625d34/sections/section-04-agent-definitions.md`
