...
Generate content for section `section-04-sec-compliance` (filename: `section-04-sec-compliance.md`).
...
for `section-04-sec-compliance` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-04-sec-compliance.md`
