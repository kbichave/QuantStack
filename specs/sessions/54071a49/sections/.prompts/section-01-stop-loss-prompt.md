...
Generate content for section `section-01-stop-loss` (filename: `section-01-stop-loss.md`).
...
for `section-01-stop-loss` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/specs/sessions/54071a49/sections/section-01-stop-loss.md`
