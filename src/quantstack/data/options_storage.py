...
class OptionsDataStore:
    ...
    def _init_schema(self) -> None:
        ...
        self.conn.execute(
            ...
            CREATE TABLE IF NOT EXISTS iv_statistics (
                ...
                iv_mean DOUBLE PRECISION,
                iv_median DOUBLE PRECISION,
                iv_std DOUBLE PRECISION,
                iv_percentile_25 DOUBLE PRECISION,
                iv_percentile_75 DOUBLE PRECISION,
                last_iv DOUBLE PRECISION,
                last_iv_rank DOUBLE PRECISION,
                last_iv_percentile DOUBLE PRECISION,
    ...
    def save_earnings(
        ...
        data = data.rename(
            columns={k: v for k, v in column_mapping.items() if k in data.columns}
        )
...
# Singleton instance
_options_store: OptionsDataStore | None = None
