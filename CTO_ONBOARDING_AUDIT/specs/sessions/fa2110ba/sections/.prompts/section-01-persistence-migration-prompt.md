...
Generate content for section `section-01-persistence-migration` (filename: `section-01-persistence-migration.md`).
...
for `section-01-persistence-migration` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/section-01-persistence-migration.md`
