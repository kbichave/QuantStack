...
Generate content for section `section-03-cost-tracking` (filename: `section-03-cost-tracking.md`).
...
for `section-03-cost-tracking` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/00f08204/sections/section-03-cost-tracking.md`
