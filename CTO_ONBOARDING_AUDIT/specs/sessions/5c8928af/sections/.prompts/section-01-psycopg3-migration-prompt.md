...
Generate content for section `section-01-psycopg3-migration` (filename: `section-01-psycopg3-migration.md`).
...
for `section-01-psycopg3-migration` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/5c8928af/sections/section-01-psycopg3-migration.md`
