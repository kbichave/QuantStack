...
Generate content for section `section-06-race-condition-fix` (filename: `section-06-race-condition-fix.md`).
...
for `section-06-race-condition-fix` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e0037533/sections/section-06-race-condition-fix.md`
