...
Generate content for section `section-07-algo-scheduler-core` (filename: `section-07-algo-scheduler-core.md`).
...
for `section-07-algo-scheduler-core` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-07-algo-scheduler-core.md`
