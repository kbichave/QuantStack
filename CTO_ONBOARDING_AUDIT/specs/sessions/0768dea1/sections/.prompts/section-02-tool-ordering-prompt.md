...
Generate content for section `section-02-tool-ordering` (filename: `section-02-tool-ordering.md`).
...
for `section-02-tool-ordering` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/0768dea1/sections/section-02-tool-ordering.md`
