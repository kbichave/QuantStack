...
Generate content for section `section-12-options-monitoring` (filename: `section-12-options-monitoring.md`).
...
for `section-12-options-monitoring` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-12-options-monitoring.md`
