...
Generate content for section `section-04-overview-tab` (filename: `section-04-overview-tab.md`).
...
for `section-04-overview-tab` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/docs/specs/sessions/d13dec59/sections/section-04-overview-tab.md`
