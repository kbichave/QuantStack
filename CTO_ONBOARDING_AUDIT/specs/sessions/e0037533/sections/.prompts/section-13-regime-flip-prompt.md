...
Generate content for section `section-13-regime-flip` (filename: `section-13-regime-flip.md`).
...
for `section-13-regime-flip` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e0037533/sections/section-13-regime-flip.md`
