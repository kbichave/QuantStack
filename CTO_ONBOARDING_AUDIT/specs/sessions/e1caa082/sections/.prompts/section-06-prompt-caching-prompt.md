...
Generate content for section `section-06-prompt-caching` (filename: `section-06-prompt-caching.md`).
...
for `section-06-prompt-caching` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/e1caa082/sections/section-06-prompt-caching.md`
