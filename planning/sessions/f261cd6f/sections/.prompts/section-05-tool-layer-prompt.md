...
Generate content for section `section-05-tool-layer` (filename: `section-05-tool-layer.md`).
...
for `section-05-tool-layer` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/planning/sessions/f261cd6f/sections/section-05-tool-layer.md`
