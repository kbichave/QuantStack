...
Generate content for section `section-02-system-alerts` (filename: `section-02-system-alerts.md`).
...
for `section-02-system-alerts` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/29e1271d/sections/section-02-system-alerts.md`
