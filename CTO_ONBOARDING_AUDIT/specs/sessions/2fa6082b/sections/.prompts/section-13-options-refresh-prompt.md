...
Generate content for section `section-13-options-refresh` (filename: `section-13-options-refresh.md`).
...
for `section-13-options-refresh` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-13-options-refresh.md`
