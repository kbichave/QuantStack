...
Generate content for section `section-01-env-validation` (filename: `section-01-env-validation.md`).
...
for `section-01-env-validation` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/69f56f5a/sections/section-01-env-validation.md`
