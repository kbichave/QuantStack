...
Generate content for section `section-03-readpoint-wiring` (filename: `section-03-readpoint-wiring.md`).
...
for `section-03-readpoint-wiring` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/fa2110ba/sections/section-03-readpoint-wiring.md`
