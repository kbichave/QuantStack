...
Generate content for section `section-08-twap-vwap` (filename: `section-08-twap-vwap.md`).
...
for `section-08-twap-vwap` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/cf3d4eb2/sections/section-08-twap-vwap.md`
