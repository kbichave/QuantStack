...
Generate content for section `section-03-prompt-caching` (filename: `section-03-prompt-caching.md`).
...
for `section-03-prompt-caching` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/0768dea1/sections/section-03-prompt-caching.md`
