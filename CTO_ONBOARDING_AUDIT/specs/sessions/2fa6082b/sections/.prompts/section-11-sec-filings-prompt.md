...
Generate content for section `section-11-sec-filings` (filename: `section-11-sec-filings.md`).
...
for `section-11-sec-filings` to understand what this section should contain.
...
`/Users/kshitijbichave/Personal/Trader/CTO_ONBOARDING_AUDIT/specs/sessions/2fa6082b/sections/section-11-sec-filings.md`
